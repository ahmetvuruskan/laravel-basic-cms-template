...
<div class="login-box">
    <div class="login-logo">
        <a href="{{route('nedmin.login')}}"><b>CMS</b>GİRİŞ YAP</a>
    </div>
    <!-- /.login-logo -->
    <div class="login-box-body">
        <p class="login-box-msg">Panele erişmek için lütfen giriş yapınız....</p>
        ...
        @endif
        <form action="{{route('nedmin.auth')}}" method="post">
            @csrf
            ...
            <div class="form-group has-feedback">
                <input type="password" class="form-control" required name="password" placeholder="Şifrenizi Giriniz.">
